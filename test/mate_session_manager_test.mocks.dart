...
// in ubuntu_session/test/mate_session_manager_test.dart.
...
import 'package:ubuntu_session/src/mate_session_manager.dart' as _i9;
...
/// A class which mocks [MateSessionManager].
///
/// See the documentation for Mockito's code generation for more information.
class MockMateSessionManager extends _i1.Mock
    implements _i9.MateSessionManager {
  MockMateSessionManager() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i6.Future<void> logout(
          {_i9.MateLogoutMode? mode = _i9.MateLogoutMode.normal}) =>
      (super.noSuchMethod(
        Invocation.method(
          #logout,
          [],
  ...
  @override
  _i6.Future<bool> isInhibited(Set<_i9.MateInhibitionFlag>? flags) =>
      (super.noSuchMethod(
        Invocation.method(
          #isInhibited,
          [flags],
